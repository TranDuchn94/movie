        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <% if(keyword == null || keyword.length() == 0) { %>
                                <span aria-hidden="true"><a style="text-decoration: none"
                                href="${pageContext.request.contextPath}/employees?pageNumber=<%=pageNumber%>">x</a></span>
                        <% } else {%>
                                <span aria-hidden="true"><a style="text-decoration: none"
                                href="${pageContext.request.contextPath}/employees/search?pageNumber=<%=pageNumber%>&keyword=<%=keyword%>&filter=<%=filter%>">x</a></span>
                        <% } %>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <% if(keyword == null || keyword.length() == 0) { %>
                            <button type="submit" class="btn btn-secondary" data-dismiss="modal"><a style="text-decoration: none"
